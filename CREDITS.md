...
All photos in `public/gallery/` and most of `public/fleet/` are **Mr Adventure Tours & Travels'
own photos** (safaris, boat trips, scooter tours and the real vehicle fleet), optimized for web.

## Licensed stock images (destinations + tuk-tuk + bicycle)
The following images were sourced from **Wikimedia Commons** and are used under their respective
free licences (mostly Creative Commons / public domain). Please keep attribution when publishing and,
ideally, **replace them with Mr Adventure's own photos** over time.
...
|------|---------|------------------|--------|
| `public/hero/leopard.jpg` | Sri Lankan leopard, Yala | Casey Klebba · CC BY-SA 4.0 | https://commons.wikimedia.org/wiki/File:Sri-lankan-leopard-yala-casey-klebba.jpg |
| `public/hero/elephant.jpg` | Safari jeep & wild elephant, Yala | Supun1991 · CC BY-SA 4.0 | https://commons.wikimedia.org/wiki/File:Yala_-_wild_elephants.jpg |
| `public/hero/sigiriya.jpg` | Sigiriya Lion Rock | WKMI96 · CC BY-SA 4.0 | https://commons.wikimedia.org/wiki/File:Front_view_of_sigiriya_Fortress.jpg |
| `public/hero/beach.jpg` | Mirissa sunset | Jacek Lesniowski · CC BY-SA 3.0 | https://commons.wikimedia.org/wiki/File:Mirissa,_Sri_Lanka_-_panoramio_(2).jpg |
| `public/hero/fishermen.jpg` | Stilt fishermen, Galle | Jakub Hałun · CC BY 4.0 | https://commons.wikimedia.org/wiki/File:Fishermen_practicing_traditional_stilt_fishing_near_Galle,_southern_Sri_Lanka,_20260207_1419_9448.jpg |

`public/destinations/sigiriya.jpg` is the same WKMI96 image above.

> Tip: for the strongest branding and full ownership, swap these out for your own Sigiriya / Ella /
> Dambulla / Pasikuda / Trincomalee photos and a picture of your actual tuk-tuk and bicycles.
