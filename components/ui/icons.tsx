...
/**
 * Google "G". Full brand colour by default (reviews badge, where it reads as a
 * trust mark); pass `mono` to inherit `currentColor` instead, for the dark
 * social-icon circles where four brand colours would muddy.
 */
...
/** Monochrome alias, so the social-icon rows stay a homogeneous list. */
export function GoogleMonoIcon(props: SVGProps<SVGSVGElement>) {
  return <GoogleIcon mono {...props} />;
}
